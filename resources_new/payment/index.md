...
#### Payment App
The development of a {{site.data.institutional.name.mixed}} Payment App, technologically speaking, more often than not, includes implementing our auth flow,  REST APIs and webhooks, as well as the Payment Provider's authentication flow, back-end-to-back-end APIs and webhook/notifications.
...
The App installation flow is a standard OAuth 2 flow. The details on the App installation flow can be found [here]({{ site.data.links.authentication.main | absolute_url }}) and the details on creating a Payment Provider can be found in our [Payment Provider API Documentation]({{ site.data.links.payment.provider | absolute_url }}).
...
*See a full example [here]({{ site.data.links.payment.provider | absolute_url }}#post-payment_providers).*
...
***Note:*** The documentation of our Checkout API can be found [here]({{ site.data.links.checkout.main | absolute_url }}). Find more details about how to implement your own SDKs on the checkout JS file on the next section.
...
The App's checkout payment options script location must be indicated in the `checkout_js_url` property of the [Payment Provider]({{ site.data.links.payment.provider | absolute_url }}) object, which our checkout will fetch when needed.

[In this link]({{ site.data.links.checkout.main | absolute_url }}) you can find very detailed information on how the Checkout JS API is implemented. 
...
The  `fields` property lets you select which optional input fields must be rendered on the card form. More information and a list of the available *fields* for this payment option can be found [here]({{ site.data.links.checkout.main | absolute_url }}#cardpayment).
...
- [Card Payment]({{ site.data.links.checkout.main | absolute_url }}#cardpayment)
- [Debit Payment]({{ site.data.links.checkout.main | absolute_url }}#debitpayment)
- [Boleto Payment]({{ site.data.links.checkout.main | absolute_url }}#boletopayment)
- [Ticket Payment]({{ site.data.links.checkout.main | absolute_url }}#ticketpayment)
- [PIX Payment]({{ site.data.links.checkout.main | absolute_url }}#pixpayment)

Details on how to render the optional ones can be found [here]({{ site.data.links.checkout.main | absolute_url }}#fields-property).
...
*The full Transaction resource specification can be found [here]({{ site.data.links.transaction.main | absolute_url }}#transaction).*
...
The [TransactionInfo]({{ site.data.links.transaction.main | absolute_url }}#transaction-info) object should be completed with all the information required for each payment method.

### Updating a Transaction

Nuvemshop's Transaction API is designed to reflect transactions that already exist and events related to those transactions that have already happened. Our Transaction API will automatically calculate the Transactions `status` on every [TransactionEvent]({{ site.data.links.transaction.main | absolute_url }}#transaction-events) reported by the Payment Provider using the [TransactionEvent endpoint]({{ site.data.links.transaction.main | absolute_url }}#transaction-events).

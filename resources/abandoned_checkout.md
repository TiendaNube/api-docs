...
A cart can be created up to 6 hours after the purchase has been abandoned.
The application must have *read_orders* permission for GET or *write_orders*  if you want to use POST as well.

...
A Product is an item for sale in a {{ site.data.institutional.name.mixed }}'s store. It can be either a good or a service.
...
| variants       | List of [Product Variant]({{ "resources/product/product_variant.md" | absolute_url }}) objects representing the different version of the Product |
| images         | List of [Product Image]({{"resources/product/product_image.md" | absolute_url }} ) objects representing the Product's images                 |
| categories     | List of [Category]({{ "resources/product/category" | absolute_url }}) objects representing the Product's categories             |
...
| created_at     | Date when the Product was created in ({% include date.iso.html %}) )     | 
| updated_at     | Date when the Product was last updated in ({% include date.iso.html %}) |
...
| created_at_min | Show Products created after date ({% include date.iso.html %})      |
| created_at_max | Show Products created before date ({% include date.iso.html %})      |
| updated_at_min | Show Products last updated after date ({% include date.iso.html %})  |
| updated_at_max | Show Products last updated before date ({% include date.iso.html %}) |

...
Read the [authentication guide]({{ "/resources/authentication" | absolute_url }}) to get started.
...
When using [scripts]({{ "/resources/script" | absolute_url }}) to integrate your app with the storefront, you may want to bind yourself to certain events or access related objects.
...
In either case, all API calls will return a `402 Payment Required` response, [Scripts]({{ "/resources/script" | absolute_url }}) will not be included and [Webhooks]({{ "/resources/webhook" | absolute_url }}) will not be called. Please make sure you handle this error code to notify the user that he needs to resume his payment instead of displaying a generic server error.
...
* [Store]({{ site.data.links.store.main | absolute_url }})
* [Product]({{ site.data.links.product.main | absolute_url }})
* [Product Variant]({{ site.data.links.product.variant | absolute_url }})
* [Product Image]({{ site.data.links.product.image | absolute_url }})
* [Category]({{ site.data.links.product.category | absolute_url }})
* [Order]({{ site.data.links.order.main | absolute_url }})
* [Customer]({{ site.data.links.customer.main | absolute_url }})
* [Script]({{ site.data.links.script.main | absolute_url }})
* [Webhook]({{ site.data.links.webhook.main | absolute_url }})
* [Coupons]({{ site.data.links.order.coupon | absolute_url }})
* [Metafields]({{ site.data.links.apps.metafields | absolute_url }})
* [Shipping Carrier]({{ site.data.links.shipping.carrier | absolute_url }})
* [Payment Provider]({{ site.data.links.payment.provider | absolute_url }})
* [Transaction]({{ site.data.links.transaction.main | absolute_url }})
* [Draft Order]({{ site.data.links.order.draft | absolute_url }})
* [Discount]({{ site.data.links.discounts.main | absolute_url }})
...
To talk with us about the API, feel free to write to <{{ site.data.institutional.email }}>.
